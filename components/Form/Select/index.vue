  ...
  <div :class="{ 'z-19': isDropdownOpen, '!cursor-not-allowed ': disabled }">
    ...
    >
      ...
      <template v-if="!disabled" #body>
        <div class="h-full   max-h-[270px] !border-gray-100">
          <div
              v-for="(item, index) in list"
              :key="index"
              class="py-3 px-4 bg-white text-gray-900 text-base capitalize transition-200 leading-5 font-medium  border-b border-solid border-gray-100"
              :class="{
              'cursor-not-allowed pointer-events-none !text-primary !bg-primary-50':
